...
let ast_constant_folding typechecking_info : Typecheck.typecheck_info =
  let FullProg (name, (prog_type, prog), interfaces) = typechecking_info.prog in
  ...
  { typechecking_info with prog = FullProg (name, prog', interfaces) }
