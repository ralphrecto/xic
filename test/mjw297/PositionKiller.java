...
public class PositionKiller {
    ...
    public static class StmtKiller implements
        ...
        public Stmt<Position> visit(AsgnArrayIndex<Position> a) {
            List<Expr<Position>> index =
                Lists.transform(a.index, e -> e.accept(new ExprKiller()));
            return AsgnArrayIndex.of(dummyPosition, kill(a.id), index,
                    a.expr.accept(new ExprKiller()));
        }
